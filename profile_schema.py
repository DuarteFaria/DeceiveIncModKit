...
FIELDS = (
    ...
    Field("diconfig.Gameplay.DisableSuspicion", "Disable suspicion",
          "bool01", "gameplay",
          help="All modes; disables suspicion checks and stamina drain",
          needs_mod="DIConfig"),
    Field("diconfig.Gameplay.DisableCover", "Disable cover",
          "bool01", "gameplay",
          help="All modes; keeps every agent permanently out of cover",
          needs_mod="DIConfig"),
    Field("diconfig.Gameplay.DisableHeat", "Disable heat",
          "bool01", "gameplay",
          help="All modes; prevents heat gain and clears existing heat",
          needs_mod="DIConfig"),
    Field("diconfig.Gameplay.DisableCoverRegeneration",
          "Disable cover regeneration", "bool01", "gameplay",
          help="All modes; existing cover can be lost but will not recharge",
          needs_mod="DIConfig"),
...
GROUPS = {
    ...
    "gameplay": ("Gameplay rules", "Server-wide DIConfig overrides"),
