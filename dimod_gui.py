...
class ProfileForm(ttk.Frame):
    ...
    def __init__(self, parent, mod_names, on_change, on_open_profile,
        ...
        self._section(body, "gameplay", 3)
        self._mods_section(body, 4)
        self._maps_section(body, 5)
        self._section(body, "extraction", 6)
        self._section(body, "spectator", 7)
        self._section(body, "scoring", 8)
        self._section(body, "advanced", 9, open_=False)
        self._raw_section(body, 10)
